...
describe('Change inventory and check item data', () => {
    ...
    it('Confirm each item\'s title, description and price', async () => {
        itemData.forEach(item => {
            InventoryPage.checkItemData(item.name, item.description, item.price)
        })
    })
})
